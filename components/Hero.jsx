    ...
    <section className="bg-brand-orange min-h-screen flex items-center py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="w-full max-w-content mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-ink space-y-6 lg:space-y-8 text-center max-w-3xl mx-auto animate-fade-in-up">
          {/* 제목 (하나의 h1로 통합) */}
          <h1 className="text-[42px] md:text-[56px] font-extrabold leading-[1.4] tracking-[-0.02em] text-ink drop-shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
            곧 다가오는 겨울방학,<br />
            지금 바로 써먹을 수 있는 겨울방학 전략 자료집
          </h1>

          {/* 부제목 (2줄) */}
          <div className="text-[20px] md:text-[24px] leading-[1.6] space-y-1 font-semibold">
            <p>대치동 예체능 재수 종합 학원 학습 관리 컨설턴트가</p>
            <p>10년의 경험을 녹여낸</p>
          </div>

          {/* 본문 */}
          <div className="text-[16px] md:text-[24px] text-ink/90 leading-relaxed">
      ...
      <div className="absolute bottom-[-100px] right-[-200px] w-[600px] md:w-[600px] lg:w-[900px] h-[600px] md:h-[600px] lg:h-[900px] opacity-40 transform rotate-[-8deg] translate-y-[25%] pointer-events-none animate-float">
